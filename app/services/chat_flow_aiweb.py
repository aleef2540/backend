from app.schemas_aiweb import ChatRequest_aiweb, ChatResponse_aiweb, ChatState_aiweb
...
async def process_chat_aiweb(req: ChatRequest_aiweb, state: ChatState_aiweb, conn) -> ChatResponse_aiweb:
